    ...
    <div className="space-y-6 overflow-x-hidden">
      ...
      <DSCard variant="gold" padding="lg" className="border-2" style={{ borderColor: colors.accent.gold }}>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <DSButton variant="outline" size="md" leftIcon={<QrCode size={18} />} className="h-11">
            Generate QR Code
          </DSButton>
        </div>
      ...
      {showGrokAssistant && (
        ...
        >
          <DSCard variant="elevated" padding="md" className="w-[min(320px,calc(100vw-24px))] shadow-xl">
