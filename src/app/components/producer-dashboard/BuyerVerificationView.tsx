...
export const BuyerVerificationView: React.FC<BuyerVerificationViewProps> = ({
  ...
  return (
    <div className="min-h-screen overflow-x-hidden p-4 sm:p-6" style={{ background: 'linear-gradient(to bottom, #F7FAFC, #D9F2FF)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Search Card */}
        <Card className="p-4 sm:p-6 mb-8 bg-white/90 backdrop-blur-sm shadow-lg">
            ...
            <div className="flex-1">
              <div className="flex gap-2">
                <Input
                  ...
                  className="min-w-0"
                />
                <Button onClick={handleVerify} disabled={isVerifying} className="h-11 text-white flex-shrink-0" style={{ backgroundColor: '#FFD700' }}>
                  <Search className="w-4 h-4 mr-2" />
                  {isVerifying ? 'Verifying...' : 'Verify'}
                </Button>
              </div>
            </div>
            <Button variant="outline" className="h-11" onClick={handleScanQR}>
        ...
        {verifiedData && (
          <>
            {/* Status Banner */}
            <Card className="p-4 sm:p-6 mb-6 bg-green-50 border-2 border-green-500">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-start gap-4">
                  <CheckCircle2 className="w-10 h-10 sm:w-12 sm:h-12 text-green-500 flex-shrink-0" />
