...
const CropJournalingTokenization: React.FC<CropJournalingTokenizationProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 overflow-x-hidden p-3 sm:p-6">
      <Card className="max-w-4xl mx-auto p-4 sm:p-8">

        {/* Header */}
        <div className="flex flex-wrap items-center gap-3 mb-6 sm:mb-8">
          <div className="p-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl flex-shrink-0">
            <BookOpen className="w-8 h-8 text-white" />
          </div>
          <div className="min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold">Crop Journaling & Tokenization</h1>
