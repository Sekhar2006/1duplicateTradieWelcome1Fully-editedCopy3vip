  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={(v: any) => setActiveTab(v)}>
        <TabsList className="flex w-full overflow-x-auto gap-0">
          <TabsTrigger value="profile" className="flex-1 min-w-0 text-xs px-1 whitespace-nowrap">
            <span>👤</span><span className="hidden sm:inline ml-1">Profile</span>
          </TabsTrigger>
          <TabsTrigger value="farm" className="flex-1 min-w-0 text-xs px-1 whitespace-nowrap">
            <span>🏡</span><span className="hidden sm:inline ml-1">Farm Details</span>
          </TabsTrigger>
          <TabsTrigger value="kyc" className="flex-1 min-w-0 text-xs px-1 whitespace-nowrap">
            <span>🛡️</span><span className="hidden sm:inline ml-1">KYC</span>
          </TabsTrigger>
          <TabsTrigger value="bank" className="flex-1 min-w-0 text-xs px-1 whitespace-nowrap">
            <span>💳</span><span className="hidden sm:inline ml-1">Bank</span>
          </TabsTrigger>
          <TabsTrigger value="history" className="flex-1 min-w-0 text-xs px-1 whitespace-nowrap">
            <span>📜</span><span className="hidden sm:inline ml-1">History</span>
          </TabsTrigger>
        </TabsList>
