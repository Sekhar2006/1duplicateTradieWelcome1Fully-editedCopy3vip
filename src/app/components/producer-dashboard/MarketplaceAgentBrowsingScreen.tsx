...
export const MarketplaceAgentBrowsingScreen: React.FC<MarketplaceAgentBrowsingScreenProps> = ({
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 overflow-x-hidden" style={{ background: 'linear-gradient(to bottom, #F7FAFC, #D9F2FF)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Search and Filters */}
        <Card className="p-4 sm:p-6 mb-6 bg-white/90 backdrop-blur-sm shadow-lg">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'marketplaces' | 'agents')}>
          <TabsList className="mb-6 w-full sm:w-auto">
            <TabsTrigger value="marketplaces" className="flex-1 sm:flex-none">
          ...
          <TabsContent value="marketplaces">
            <div className="space-y-4">
              {filteredMarketplaces.map((marketplace) => (
                <Card key={marketplace.id} className="p-4 sm:p-6 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-lg bg-green-100 flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span className="break-words">{marketplace.location} • {marketplace.distance} km</span>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Button
                          ...
                          className="h-11 text-white flex-1 sm:flex-none"
                          style={{ backgroundColor: '#FFD700' }}
                        >
                          <Phone className="w-4 h-4 mr-2" />
                          Contact Marketplace
                        </Button>
                        <Button variant="outline" className="h-11 flex-1 sm:flex-none">View Reviews</Button>
                      </div>
                    </div>
                  </div>
                </Card>
          ...
          <TabsContent value="agents">
            <div className="space-y-4">
              {filteredAgents.map((agent) => (
                <Card key={agent.id} className="p-4 sm:p-6 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#FFD70020' }}>
                        <Users className="w-8 h-8 sm:w-10 sm:h-10" style={{ color: '#FFD700' }} />
                      </div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Button variant="outline" className="h-11 flex-1 sm:flex-none">View Profile</Button>
                      </div>
                    </div>
                  </div>
                </Card>
