...
export default function ProvenanceTracker() {
  ...
  const renderCommoditySelection = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl sm:text-2xl text-[#003E6D] mb-2">Select Commodity & Variety</h2>
        <p className="text-gray-600 text-sm sm:text-base">Choose your crop type to generate unique Batch ID</p>
      </div>
      ...
      <Card className="bg-white/90 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
          {/* Category Selection - 2 cols on mobile, 3 on sm+ */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {Object.entries(COMMODITY_CATEGORIES).map(([key, config]) => (
              ...
              >
                ...
                <div className="text-xs sm:text-sm font-medium text-[#003E6D]">{config.label}</div>
              </button>
            ))}
          </div>
              ...
              {selectedVariety && (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <Hash className="w-5 h-5 text-[#003E6D] flex-shrink-0" />
                    <Label className="text-sm text-gray-600">Crop Batch ID (will be generated)</Label>
                  </div>
                  <div className="text-base sm:text-lg font-mono text-[#003E6D] break-all">
          ...
          <Button
            ...
            className="w-full bg-[#FFD700] text-[#003E6D] hover:bg-[#FFD700]/90 min-h-[44px]"
            size="lg"
          >
        ...
        <CardContent className="p-4">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div className="min-w-0">
              ...
              <code className="text-base sm:text-lg font-mono text-[#003E6D] break-all">
                {cropBatch?.cropBatchId}
              </code>
            </div>
            <Badge className="bg-[#FFD700] text-[#003E6D] flex-shrink-0 text-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-2">
              {commodityConfig.harvestMethods.map((method) => (
                <button
                  ...
                  className={`p-2 sm:p-3 rounded-lg border-2 text-xs sm:text-sm transition-all min-h-[44px] ${
                ...
                <div key={stage.id} className="p-4 bg-blue-50 rounded-lg">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="font-medium text-[#003E6D] truncate">{stage.stageName}</p>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2 text-sm">
                    {Object.entries(stage.criteria).map(([key, value]) => (
                      <div key={key} className="flex justify-between gap-1">
                        ...
                        <span className="text-[#003E6D] font-medium flex-shrink-0">{value}</span>
                      </div>
                    ))}
                  </div>
                  {stage.notes && (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              {gradingStages.length > 0 && (
                <Button
                  ...
                  className="flex-1 bg-[#FFD700] text-[#003E6D] hover:bg-[#FFD700]/90 min-h-[44px]"
                >
                  Finalize & Continue
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-600 truncate">{verification.verifierName}</p>
                      </div>
                    </div>
                    <Badge className="bg-green-600 text-white flex-shrink-0">Verified</Badge>
                  </div>
                  {verification.rating && (
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
        <CardContent className="p-4 sm:p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl">Quality Token Generated!</h2>
      ...
      <Card className="bg-white/90">
        ...
        <CardContent className="flex flex-col items-center">
          <div className="p-4 sm:p-6 bg-white rounded-xl border-4 border-[#FFD700] shadow-lg">
            <img
        ...
        <Card className="bg-gradient-to-r from-[#FFD700]/20 to-[#FFD700]/10 border-2 border-[#FFD700]">
          <CardContent className="p-4 sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="min-w-0">
                <h2 className="text-xl sm:text-2xl text-[#003E6D] mb-1">Complete Provenance History</h2>
                <p className="text-gray-600 text-sm">Full lifecycle tracking for {cropBatch?.variety}</p>
              </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          <Card>
            <CardContent className="p-3 sm:p-4 text-center">
              ...
              <p className="text-xl sm:text-2xl font-bold text-[#003E6D]">{harvestData.quantity || 'N/A'}</p>
              <p className="text-xs sm:text-sm text-gray-600">Harvested ({harvestData.unit})</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3 sm:p-4 text-center">
              <Award className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 text-blue-600" />
              <p className="text-xl sm:text-2xl font-bold text-[#003E6D]">{gradingStages.length}</p>
              <p className="text-xs sm:text-sm text-gray-600">Grading Stages</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3 sm:p-4 text-center">
              <Shield className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 text-purple-600" />
              <p className="text-xl sm:text-2xl font-bold text-[#003E6D]">{verifications.length}</p>
              <p className="text-xs sm:text-sm text-gray-600">Verifications</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3 sm:p-4 text-center">
              <Clock className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 text-orange-600" />
              <p className="text-xl sm:text-2xl font-bold text-[#003E6D]">{timeline.length}</p>
              <p className="text-xs sm:text-sm text-gray-600">Timeline Events</p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div key={entry.id} className="flex gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0 pb-8">
                      <div className="flex flex-wrap items-start justify-between gap-1 mb-1">
                        <h4 className="font-semibold text-[#003E6D] min-w-0">{entry.title}</h4>
                      ...
                      {entry.data && (
                        <div className="p-3 bg-gray-50 rounded text-xs overflow-x-auto">
                          <pre>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F7FAFC] to-[#D9F2FF] p-4 sm:p-6 overflow-x-hidden">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-[#003E6D] mb-2 text-lg sm:text-2xl">
            Producer Quality Verification & Provenance Tracking
          </h1>
                  ...
                  return (
                    <React.Fragment key={s.key}>
                      <div className="flex flex-col items-center">
                        ...
                        <p className={`text-xs hidden sm:block ${isActive ? 'text-[#003E6D] font-semibold' : 'text-gray-600'}`}>
                          {s.label}
                        </p>
                      </div>
                      {index < 5 && (
