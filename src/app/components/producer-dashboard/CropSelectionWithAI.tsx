...
const CropSelectionWithAI: React.FC<CropSelectionProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 overflow-x-hidden p-3 sm:p-6">
      <div className="max-w-6xl mx-auto space-y-6">

        {/* Header */}
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold mb-2">🌾 Crop Selection with AI Insights</h1>
      ...
      <div className="flex items-start justify-between gap-2 mb-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <h4 className="font-bold text-lg truncate">{recommendation.crop}</h4>
            {isSelected && (
