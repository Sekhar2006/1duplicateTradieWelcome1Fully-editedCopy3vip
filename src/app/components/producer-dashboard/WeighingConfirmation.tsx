...
const WeighingConfirmation: React.FC<WeighingConfirmationProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50 p-3 sm:p-6 overflow-x-hidden">
      <Card className="max-w-4xl mx-auto p-4 sm:p-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">Weighing & Final Settlement</h1>
            <p className="text-gray-600">Confirm weight and finalize payment</p>
          </div>
        </div>

        {/* Placeholder Content */}
        <div className="bg-gradient-to-br from-green-100 to-teal-100 p-6 sm:p-12 rounded-xl text-center mb-8">
