    ...
    return (
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          {/* Commodity Selection */}
          <DSCard className="p-4 sm:p-6 mb-6">
            <h2
    ...
    return (
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <button
            onClick={handleReset}
            className="flex items-center gap-2 text-gray-600 mb-4 hover:text-gray-800 min-h-[44px]"
          >
    ...
    return (
      ...
      >
        <div className="text-center max-w-md w-full">
          ...
          {/* Summary */}
          {aiResults && (
            <DSCard className="p-4 sm:p-6 mb-6 text-left">
