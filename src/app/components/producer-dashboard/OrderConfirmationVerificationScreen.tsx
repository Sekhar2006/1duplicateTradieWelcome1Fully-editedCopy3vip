...
export const OrderConfirmationVerificationScreen: React.FC<OrderConfirmationVerificationScreenProps> = ({
  ...
  return (
    <div className="min-h-screen p-3 sm:p-6 overflow-x-hidden" style={{ background: 'linear-gradient(to bottom, #F7FAFC, #D9F2FF)' }}>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
              <div className="min-w-0">
                <p className="break-words" style={{ color: '#003E6D' }}>{orderDetails.buyer.name}</p>
                <p className="text-sm text-gray-600 break-words">{orderDetails.buyer.company}</p>
              </div>
              {orderDetails.buyer.verified && (
                <Badge className="bg-blue-500 text-white flex-shrink-0">Verified Buyer</Badge>
              )}
            </div>
          </div>
        </Card>
